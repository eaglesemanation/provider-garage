module github.com/eaglesemanation/provider-garage
...
require (
	...
	github.com/jkossis/terraform-provider-garage v0.0.0-00010101000000-000000000000
...
replace github.com/jkossis/terraform-provider-garage => ./terraform-provider-garage
