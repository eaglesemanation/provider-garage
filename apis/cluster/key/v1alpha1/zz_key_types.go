...
type KeyInitParameters struct {
	...
	// friendly name for the access key.
	// A human-friendly name for the access key.
	Name *string `json:"name,omitempty" tf:"name,omitempty"`

	// (String, Sensitive) The secret access key. If not provided, one will be generated (only available on creation).
	// The secret access key. If not provided, one will be generated (only available on creation).
	SecretAccessKeySecretRef *v1.SecretKeySelector `json:"secretAccessKeySecretRef,omitempty" tf:"-"`
}

type KeyObservation struct {

	// (String) The access key ID. If not provided, one will be generated.
...
// Key is the Schema for the Keys API. Manages a Garage access key.
