...
type PermissionInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/eaglesemanation/provider-garage/apis/cluster/key/v1alpha1.Key
	...
	// +crossplane:generate:reference:type=github.com/eaglesemanation/provider-garage/apis/cluster/bucket/v1alpha1.Bucket
